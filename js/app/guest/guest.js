...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'Stefany Chrisdianty Birthday Celebration',
            dates: `${formatDate('2025-12-21 09:00')}/${formatDate('2025-12-21 16:00')}`,
            details: 'You are invited because this is your day. Let\'s celebrate together!',
            location: 'Jl. Taruna No.50, RT.2/RW.4, Pd. Bambu, Kec. Duren Sawit, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13430',
            ctz: config.get('tz'),
        });
